			...
			<div className='section-container'>
				...
				<div className='grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12'>
					...
					<div className='bg-white p-8 rounded-lg shadow'>
						...
						<p className='text-neutral-600 mb-4'>Wyślij nam wiadomość, odpowiemy w ciągu 2 godzin</p>
						<a href='mailto:info@kubuspozyczki.pl' className='text-primary-700 font-semibold hover:underline'>
							info@kubuspozyczki.pl
						</a>
					</div>
					...
					<div className='bg-white p-8 rounded-lg shadow'>
						...
						<a href='tel:+48123456789' className='text-primary-700 font-semibold hover:underline'>
							+48 123 456 789
						</a>
					</div>
					...
					<div className='flex items-start gap-4'>
						...
						<div>
							...
							<div className='grid grid-cols-2 gap-4 text-sm text-neutral-700'>
								...
								<div>
									<p className='font-semibold'>Chat 24/7</p>
									<p>Zawsze dostępny</p>
								</div>
							</div>
						</div>
